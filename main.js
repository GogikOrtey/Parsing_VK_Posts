...
// Ключ доступа к API
const accessToken = '37382a8c37382a8c37382a8ca9352001943373837382a8c5108cd6d715313038c2969d5';
...
if(accessToken == '') {
    console.log("В программе не указан Ключ доступа к API. Его нужно указать в переменной accessToken, на ~21 строчке кода")
