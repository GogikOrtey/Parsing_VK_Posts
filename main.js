...
let startCount = 10     // Лучшее значение - это 10 или 20. Макисмальное = 100
let startOffset = 0     // = 0, если мы хотим начать с верха сообщества
let allCount = -1       // Сколько мы обработаем изображений // = -1, если без ограничения
...
let bool_isStopedBeforePool = true;     // Мы останавливаем программу, после того как нам встретился опрос?
