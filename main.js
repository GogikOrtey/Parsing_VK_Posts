...
v=5.130`)
    ...
    .then(json => {
        ...
        json.response.items.forEach(item => {
            ...
            // Добавить код, который извлекает текст, и если он слишком длинный, запихивает его в txt файл, 
            // с тем-же названием, что и у [первого] изображения этого поста
